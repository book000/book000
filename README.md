...
```math
\ce{$&#x5C;unicode[pointer-events: none; z-index: -20; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 100vw; opacity: 0.3; background: center no-repeat url('https://avatars.githubusercontent.com/u/8929706?v=4'); border-radius:50%]{x0000}$}
```
